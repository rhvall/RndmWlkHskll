...
-- https://hackage.haskell.org/package/easyplot
...
data Graph2D x y = Function2D [Option] [Option2D x y] (x -> y)
...
data Graph3D x y z = Function3D [Option] [Option3D x y z] (x -> y -> z)
